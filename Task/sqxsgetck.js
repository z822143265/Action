...
if(url.indexOf('activity/xapi/gold/withdraw/info')!=-1)
{
	...
	if(url)
	{
		...
		let zhhd=headers;
		let zhbd=body;
		$.setdata(zhurl ,'zhurl'+ $.idx)
		$.setdata(zhhd ,'zhhd'+ $.idx)
		$.setdata(zhbd ,'zhbd'+ $.idx)
	}
}
...
if(url.indexOf('activity/xapi/gold/withdraw?asac')!=-1)
{
	...
	if(url)
	{
		...
		let withdrawbd=body;
		$.setdata(withdrawurl ,'withdrawurl'+ $.idx)
		$.setdata(withdrawhd ,'withdrawhd'+ $.idx)
		$.setdata(withdrawbd ,'withdrawbd'+ $.idx)
	}
}
